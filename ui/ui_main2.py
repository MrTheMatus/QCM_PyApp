...
class Ui_AffordableQCM(object):
    def setupUi(self, AffordableQCM):
        ...
        self.densityEditLineEdit.setGeometry(QtCore.QRect(680, 200, 121, 41))
        font = QtGui.QFont()
        font.setPointSize(16)
        ...
        self.densityEditLabel.setGeometry(QtCore.QRect(690, 160, 111, 31))
        font = QtGui.QFont()
        font.setPointSize(16)
        self.densityEditLabel.setFont(font)
        self.densityEditLabel.setObjectName("densityEditLabel")
        self.densityUnitEditLabel = QtWidgets.QLabel(self.materialsPage)
        self.densityUnitEditLabel.setGeometry(QtCore.QRect(840, 160, 111, 31))
        font = QtGui.QFont()
        font.setPointSize(16)
        self.densityUnitEditLabel.setFont(font)
        self.densityUnitEditLabel.setObjectName("densityUnitEditLabel")
        self.materialunitComboBox = QtWidgets.QComboBox(self.materialsPage)
        self.materialunitComboBox.setGeometry(QtCore.QRect(840, 210, 121, 32))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.materialunitComboBox.setFont(font)
        self.materialunitComboBox.setObjectName("materialunitComboBox")
    ...
    def retranslateUi(self, AffordableQCM):
        ...
        self.densityUnitEditLabel.setText(_translate("AffordableQCM", "Unit"))
